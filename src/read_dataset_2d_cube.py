...
class DataSet(object):
    ...
    def get_input_and_label(self, start, end):
        ...
        labels=np.zeros((int(end-start),6), "float")
                ...
                for line_labels in file_labels:
                    ...
                    if values_labels[0] == self.objects_[i].split(".")[0]:
                        ...
                        if values_labels[1] == "cube":
                            ...
                            labels[0] = (float(values_labels[2])-4)/16
                            labels[1] = (float(values_labels[3])-4)/16
                            labels[2] = (float(values_labels[4])-4)/11
