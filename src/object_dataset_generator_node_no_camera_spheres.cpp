...
int main(int argc, char** argv){
  ...
  ObjectDatasetGenerator dataset("/home/penalvea/spheres/general.txt", "/home/penalvea/spheres/geometrics", workspace);
  ...
  /*while(!std::ifstream("/home/penalvea/cylinders/stop")){
    ...
    if(!std::ifstream("/home/penalvea/cylinders/stop")){*/
      ...
      std::string del;
      del="rm -r /home/penalvea/spheres/geometrics/first/training/complete_objects/*";
      system(del.c_str());
      del="rm -r /home/penalvea/spheres/geometrics/first/training/side_objects/*";
      system(del.c_str());
      del="rm -r /home/penalvea/spheres/geometrics/first/validation/complete_objects/*";
      system(del.c_str());
      del="rm -r /home/penalvea/spheres/geometrics/first/validation/side_objects/*";
      system(del.c_str());
