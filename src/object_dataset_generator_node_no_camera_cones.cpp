...
int main(int argc, char** argv){
  ...
  ObjectDatasetGenerator dataset("/home/penalvea/cones/general.txt", "/home/penalvea/cones/geometrics", workspace);
  ...
  /*while(!std::ifstream("/home/penalvea/cylinders/stop")){
    ...
    if(!std::ifstream("/home/penalvea/cylinders/stop")){*/
      ...
      std::string del;
      del="rm -r /home/penalvea/cones/geometrics/first/training/complete_objects/*";
      system(del.c_str());
      del="rm -r /home/penalvea/cones/geometrics/first/training/side_objects/*";
      system(del.c_str());
      del="rm -r /home/penalvea/cones/geometrics/first/validation/complete_objects/*";
      system(del.c_str());
      del="rm -r /home/penalvea/cones/geometrics/first/validation/side_objects/*";
      system(del.c_str());
