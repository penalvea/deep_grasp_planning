...
dataset_path="/home/penalvea/cones/geometrics"

write_objects1="/home/penalvea/cones/first"
ready_objects1="/home/penalvea/cones/first_ready"
write_objects2="/home/penalvea/cones/second"
ready_objects2="/home/penalvea/cones/second_ready"
write_objects3="/home/penalvea/cones/third"
ready_objects3="/home/penalvea/cones/third_ready"
write_objects4="/home/penalvea/cones/fourth"
ready_objects4="/home/penalvea/cones/fourth_ready"
write_objects5="/home/penalvea/cones/fifth"
ready_objects5="/home/penalvea/cones/fifth_ready"
write_objects6="/home/penalvea/cones/sixth"
ready_objects6="/home/penalvea/cones/sixth_ready"
write_objects7="/home/penalvea/cones/seventh"
ready_objects7="/home/penalvea/cones/seventh_ready"
write_objects8="/home/penalvea/cones/eighth"
ready_objects8="/home/penalvea/cones/eighth_ready"
write_objects9="/home/penalvea/cones/nineth"
ready_objects9="/home/penalvea/cones/nineth_ready"
write_objects10="/home/penalvea/cones/tenth"
ready_objects10="/home/penalvea/cones/tenth_ready"
...
output_path="/home/penalvea/NetResults/cones"
...
train_writer=tf.summary.FileWriter("/home/penalvea/tensorboard/cones/train", sess.graph)
test_writer=tf.summary.FileWriter("/home/penalvea/tensorboard/cones/test")
...
while(now<run_until):
    if change==1:
        if folder==1:
            ...
            [training, validation] = read_dataset_2d_cones.readNextDataSet(dataset_path, folder1, height, width, depth)
            ...
            [training, validation] = read_dataset_2d_cones.readNextDataSet(dataset_path, folder2, height, width, depth)
            ...
            [training, validation] = read_dataset_2d_cones.readNextDataSet(dataset_path, folder3, height, width, depth)
            ...
            [training, validation] = read_dataset_2d_cones.readNextDataSet(dataset_path, folder4, height, width, depth)
            ...
            [training, validation] = read_dataset_2d_cones.readNextDataSet(dataset_path, folder5, height, width, depth)
            ...
            [training, validation] = read_dataset_2d_cones.readNextDataSet(dataset_path, folder6, height, width, depth)
            ...
            [training, validation] = read_dataset_2d_cones.readNextDataSet(dataset_path, folder7, height, width, depth)
            ...
            [training, validation] = read_dataset_2d_cones.readNextDataSet(dataset_path, folder8, height, width, depth)
            ...
            [training, validation] = read_dataset_2d_cones.readNextDataSet(dataset_path, folder9, height, width, depth)
            ...
            [training, validation] = read_dataset_2d_cones.readNextDataSet(dataset_path, folder10, height, width, depth)
