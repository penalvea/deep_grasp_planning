...
int main(int argc, char** argv){
  ...
  while(!std::ifstream("/home/penalvea/dataset2/stop")){
    while(!std::ifstream("/home/penalvea/dataset2/tenth") && !std::ifstream("/home/penalvea/dataset2/stop")){
      sleep(10);
    }
    std::remove("/home/penalvea/dataset2/tenth");
    if(!std::ifstream("/home/penalvea/dataset2/stop")){


      std::string del;
      del="rm -r /home/penalvea/dataset2/geometrics/tenth/training/complete_objects/*";
      system(del.c_str());
      del="rm -r /home/penalvea/dataset2/geometrics/tenth/training/side_objects/*";
      system(del.c_str());
      del="rm -r /home/penalvea/dataset2/geometrics/tenth/validation/complete_objects/*";
      system(del.c_str());
      del="rm -r /home/penalvea/dataset2/geometrics/tenth/validation/side_objects/*";
      system(del.c_str());
      ...
      std::ofstream outfile ("/home/penalvea/dataset2/tenth_ready");
      outfile.close();
    }
