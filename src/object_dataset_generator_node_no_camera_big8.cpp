...
int main(int argc, char** argv){
  ...
  while(!std::ifstream("/home/penalvea/dataset2/stop")){
    while(!std::ifstream("/home/penalvea/dataset2/eighth") && !std::ifstream("/home/penalvea/dataset2/stop")){
      sleep(10);
    }
    std::remove("/home/penalvea/dataset2/eighth");
    if(!std::ifstream("/home/penalvea/dataset2/stop")){


      std::string del;
      del="rm -r /home/penalvea/dataset2/geometrics/eighth/training/complete_objects/*";
      system(del.c_str());
      del="rm -r /home/penalvea/dataset2/geometrics/eighth/training/side_objects/*";
      system(del.c_str());
      del="rm -r /home/penalvea/dataset2/geometrics/eighth/validation/complete_objects/*";
      system(del.c_str());
      del="rm -r /home/penalvea/dataset2/geometrics/eighth/validation/side_objects/*";
      system(del.c_str());
      ...
      std::ofstream outfile ("/home/penalvea/dataset2/eighth_ready");
      outfile.close();
    }
