...
import time
import datetime
import read_dataset_2d_spheres
...
dataset_path="/home/penalvea/spheres/geometrics"

write_objects1="/home/penalvea/spheres/first"
ready_objects1="/home/penalvea/spheres/first_ready"
write_objects2="/home/penalvea/spheres/second"
ready_objects2="/home/penalvea/spheres/second_ready"
write_objects3="/home/penalvea/spheres/third"
ready_objects3="/home/penalvea/spheres/third_ready"
write_objects4="/home/penalvea/spheres/fourth"
ready_objects4="/home/penalvea/spheres/fourth_ready"
write_objects5="/home/penalvea/spheres/fifth"
ready_objects5="/home/penalvea/spheres/fifth_ready"
write_objects6="/home/penalvea/spheres/sixth"
ready_objects6="/home/penalvea/spheres/sixth_ready"
write_objects7="/home/penalvea/spheres/seventh"
ready_objects7="/home/penalvea/spheres/seventh_ready"
write_objects8="/home/penalvea/spheres/eighth"
ready_objects8="/home/penalvea/spheres/eighth_ready"
write_objects9="/home/penalvea/spheres/nineth"
ready_objects9="/home/penalvea/spheres/nineth_ready"
write_objects10="/home/penalvea/spheres/tenth"
ready_objects10="/home/penalvea/spheres/tenth_ready"
...
output_path="/home/penalvea/NetResults/spheres"
...
def inference_4layers(inp):
    ...
    lineal1=denselyConnLayerLineal(dens2, 50, 1, 'lineal1_cylinder')
...
train_writer=tf.summary.FileWriter("/home/penalvea/tensorboard/spheres/train", sess.graph)
test_writer=tf.summary.FileWriter("/home/penalvea/tensorboard/spheres/test")
...
while(now<run_until):
    if change==1:
        if folder==1:
            ...
            [training, validation] = read_dataset_2d_spheres.readNextDataSet(dataset_path, folder1, height, width, depth)
            ...
            [training, validation] = read_dataset_2d_spheres.readNextDataSet(dataset_path, folder2, height, width, depth)
            ...
            [training, validation] = read_dataset_2d_spheres.readNextDataSet(dataset_path, folder3, height, width, depth)
            ...
            [training, validation] = read_dataset_2d_spheres.readNextDataSet(dataset_path, folder4, height, width, depth)
            ...
            [training, validation] = read_dataset_2d_spheres.readNextDataSet(dataset_path, folder5, height, width, depth)
            ...
            [training, validation] = read_dataset_2d_spheres.readNextDataSet(dataset_path, folder6, height, width, depth)
            ...
            [training, validation] = read_dataset_2d_spheres.readNextDataSet(dataset_path, folder7, height, width, depth)
            ...
            [training, validation] = read_dataset_2d_spheres.readNextDataSet(dataset_path, folder8, height, width, depth)
            ...
            [training, validation] = read_dataset_2d_spheres.readNextDataSet(dataset_path, folder9, height, width, depth)
            ...
            [training, validation] = read_dataset_2d_spheres.readNextDataSet(dataset_path, folder10, height, width, depth)
    ...
    if i>0 and i%int(train_objects/batch_size)==0:
        ...
        print ("iteration %d, loss_function: %.6f, radius error: %.2felapsed time: %.2f, iteration time: %.2f" % (i/int(train_objects/batch_size) , acum/objects, radius_acum/objects, (new_time-init_time)/60,  (new_time-start_time)/60))
        print ((radius_acum/objects)*6)
        ...
        if epochs%10==0:
            ...
            print ((radius_acum_test / objects_test) * 6)
