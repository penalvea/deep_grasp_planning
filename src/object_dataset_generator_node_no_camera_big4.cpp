...
int main(int argc, char** argv){
  ...
  while(!std::ifstream("/home/penalvea/dataset2/stop")){
    while(!std::ifstream("/home/penalvea/dataset2/fourth") && !std::ifstream("/home/penalvea/dataset2/stop")){
      sleep(10);
    }
    std::remove("/home/penalvea/dataset2/fourth");
    if(!std::ifstream("/home/penalvea/dataset2/stop")){


      std::string del;
      del="rm -r /home/penalvea/dataset2/geometrics/fourth/training/complete_objects/*";
      system(del.c_str());
      del="rm -r /home/penalvea/dataset2/geometrics/fourth/training/side_objects/*";
      system(del.c_str());
      del="rm -r /home/penalvea/dataset2/geometrics/fourth/validation/complete_objects/*";
      system(del.c_str());
      del="rm -r /home/penalvea/dataset2/geometrics/fourth/validation/side_objects/*";
      system(del.c_str());
      ...
      std::ofstream outfile ("/home/penalvea/dataset2/fourth_ready");
      outfile.close();
    }
